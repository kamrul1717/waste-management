...
{{--                                <img src="../../{{url('website')}}/assets/images/demo/saas.png" alt="" class="img-fluid">--}}
{{--                            </label>--}}
{{--                        </div>--}}
...
{{--                                <img src="../../{{url('website')}}/assets/images/demo/corporate.png" alt="" class="img-fluid">--}}
{{--                            </label>--}}
{{--                        </div>--}}
...
{{--                                <img src="../../{{url('website')}}/assets/images/demo/galaxy.png" alt="" class="img-fluid">--}}
{{--                            </label>--}}
{{--                        </div>--}}
...
{{--                                <img src="../../{{url('website')}}/assets/images/demo/material.png" alt="" class="img-fluid">--}}
{{--                            </label>--}}
{{--                        </div>--}}
...
{{--                                <img src="../../{{url('website')}}/assets/images/demo/creative.png" alt="" class="img-fluid">--}}
{{--                            </label>--}}
{{--                        </div>--}}
...
{{--                                <img src="../../{{url('website')}}/assets/images/demo/minimal.png" alt="" class="img-fluid">--}}
{{--                            </label>--}}
{{--                        </div>--}}
...
{{--                                <img src="../../{{url('website')}}/assets/images/demo/modern.png" alt="" class="img-fluid">--}}
{{--                            </label>--}}
{{--                        </div>--}}
...
{{--                                <img src="../../{{url('website')}}/assets/images/demo/interactive.png" alt="" class="img-fluid">--}}
{{--                            </label>--}}
{{--                        </div>--}}
...
{{--                                <img src="../../{{url('website')}}/assets/images/demo/classic.png" alt="" class="img-fluid">--}}
{{--                            </label>--}}
{{--                        </div>--}}
...
{{--                                <img src="../../{{url('website')}}/assets/images/demo/vintage.png" alt="" class="img-fluid">--}}
{{--                            </label>--}}
{{--                        </div>--}}
                    ...
                    <div class="d-flex gap-2 flex-wrap img-switch">
                        ...
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                <img src="{{url('website')}}/assets/images/sidebar/img-1.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                            </label>
                        </div>
                        ...
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                <img src="{{url('website')}}/assets/images/sidebar/img-2.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                            </label>
                        </div>
                        <div class="form-check sidebar-setting card-radio">
                            <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-03" value="img-3">
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                <img src="{{url('website')}}/assets/images/sidebar/img-3.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                            </label>
                        </div>
                        <div class="form-check sidebar-setting card-radio">
                            <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-04" value="img-4">
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                <img src="{{url('website')}}/assets/images/sidebar/img-4.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                            </label>
                        </div>
                    </div>
                </div>
